...
Shop_Screen::Shop_Screen() : Screen(9, 8, true, false, false) {
	...
	setup_helper(true, 1, NULL, 100.f, 150.f,  80.f, 50.f);
	setup_helper(true, 2, NULL, 290.f,  80.f, 120.f, 50.f);
	setup_helper(true, 3, NULL, 290.f, 150.f, 120.f, 50.f);
	setup_helper(true, 4, NULL, 450.f,  80.f, 130.f, 50.f);

	setup_helper(true, 5, NULL,  113.f,  125.f,  50.f,  0.f);
	setup_helper(true, 6, NULL,  300.f,  125.f, 100.f,  0.f);

	setup_helper(false, 0, "Shop", 360.f, 20.f, 36.f, NULL);

	setup_helper(false, 1,     "Buy", 110.f,  90.f, 30.f, NULL);
	setup_helper(false, 2,    "Sell", 110.f, 160.f, 30.f, NULL);
	setup_helper(false, 3,   "Items", 300.f,  90.f, 30.f, NULL);
	setup_helper(false, 4,  "Spells", 300.f, 160.f, 30.f, NULL);
	setup_helper(false, 5, "Special", 460.f,  90.f, 30.f, NULL);
